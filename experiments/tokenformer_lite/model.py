"""TokenFormer-Lite model wrapper.

Dynamically loads the TokenFormer model from the parent tokenformer package.
All architecture decisions are controlled via __init__.py kwargs.
"""
