"""Python runtime for the top-level run.sh bootstrapper (Windows — no uv)."""
...
def _run_console_script(
    *,
    ...
    write_stderr_line(f"unsupported TAAC_RUNNER: {runner_mode}; expected 'python'")
    return 2
